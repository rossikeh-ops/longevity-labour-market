...
<div class="cards">
  <div class="oc" style="--c:var(--slate)"><div class="ic">👷</div>
    <h3>Who keeps working<span class="info" data-tip="Labour supply in human-working-years = healthy working-age people × working life × participation (Level 1) — the labour the population can actually supply.">i</span></h3><p class="q">Labour supply — human-working-years</p>
  ...
  <div class="oc" style="--c:var(--mustard)"><div class="ic">🏖️</div>
    <h3>Who retires<span class="info" data-tip="Population × years lived beyond the statutory retirement age (LE − retirement age) — total person-years spent in retirement. The bar splits them into healthy vs poor-health years.">i</span></h3><p class="q">Years lived beyond the retirement age</p>
  ...
  <div class="oc" style="--c:var(--terra)"><div class="ic">🏥</div>
    <h3>Who needs healthcare<span class="info" data-tip="Population × years lived in poor health (LE − HLY) (Level 4). Lower is better — more healthy life years means less care needed.">i</span></h3><p class="q">Poor-health person-years (LE − HLY)</p>
  ...
  <div class="oc" style="--c:var(--acc)"><div class="ic">🎭</div>
    <h3>Who fills concert halls &amp; courses<span class="info" data-tip="Population × healthy years after retirement (HLY − retirement age, floored at 0) (Level 5) — the active, healthy retirees who fill leisure, education &amp; culture.">i</span></h3><p class="q">Healthy years after retirement</p>
