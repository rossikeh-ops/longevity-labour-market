...
# downward flow connector (vertical line + chevron) between pipeline stages
CONN = ('<div class="conn"><svg width="18" height="30" viewBox="0 0 18 30" '
        'xmlns="http://www.w3.org/2000/svg">'
        '<line x1="9" y1="0" x2="9" y2="21" stroke="#5b9dff" stroke-width="3" opacity="0.5"/>'
        '<path d="M3,16 L9,23 L15,16" fill="none" stroke="#5b9dff" stroke-width="3" '
        'stroke-linecap="round" stroke-linejoin="round" opacity="0.85"/></svg></div>')
...
.levels{display:flex;flex-direction:column;gap:0;margin:18px 0}
...
/* flow connector between pipeline stages, aligned under the number badges */
.conn{height:30px;display:flex;align-items:center;padding-left:32px}
...
<h3>Labour supply</h3>
<div class="io">Healthy person-years — driver forecasts and the supply identity are detailed in §1 below.</div></div></div>
{CONN}
