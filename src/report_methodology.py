...
STAGES = [
    dict(c="#5b9dff", kick="Level 0", title="Data foundation", icon="db",
    ...
    dict(c="#2dd4bf", kick="Level 1", title="Labour supply", icon="heart",
    ...
    dict(c="#fbbf24", kick="Level 2", title="Labour demand", icon="bag",
    ...
    dict(c="#34d399", kick="Level 3", title="Balance — the headline", icon="scale",
...
border-radius:50%;background:#eaf3ff;box-shadow:0 0 10px 2px var(--c);animation:flowdot 2.4s ease-in-out infinite}
...
.enode svg{stroke:#06203a;fill:none;stroke-width:1.7;stroke-linecap:round;stroke-linejoin:round}
...
.ecard .chip{display:inline-block;margin-top:10px;background:#0e1830;border:1px solid var(--line);
