...
d1 = "".join([
    ...
    arrow(322, 70, 72, 100, "a1"), arrow(331, 70, 206, 100, "a1"),
    arrow(340, 70, 340, 100, "a1"), arrow(349, 70, 474, 100, "a1"),
    arrow(358, 70, 608, 100, "a1"),
    box(12, 104, 120, 56, "Linear trend", "OLS regression", "blue"),
    box(146, 104, 120, 56, "Damped Holt", "smooths the trend", "teal"),
    box(280, 104, 120, 56, "Drift", "random walk", "amber"),
    box(414, 104, 120, 56, "Naive", "last value", "gray"),
    box(548, 104, 120, 56, "AR(1)", "mean-reversion", "purple"),
    arrow(72, 160, 305, 204, "a1"), arrow(206, 160, 323, 204, "a1"),
    arrow(340, 160, 340, 204, "a1"), arrow(474, 160, 357, 204, "a1"),
    arrow(608, 160, 375, 204, "a1"),
    box(207, 206, 266, 52, "Mean forecast (ensemble)", "= average of the 5 models", "green"),
...
<p><b>See it for yourself.</b> The <a href="flexibility.html">model-flexibility playground</a> lets you drag one
slider from underfit to overfit on a real Healthy-Life-Years series, with the cross-validated optimum — and the
classic train-error-falls / CV-error-U-shape tradeoff — computed live. It is the same lesson, made tactile:
on 13–21 years of data, the sweet spot is a modest flexibility, and a neural network would sit far into the overfit zone.</p>
